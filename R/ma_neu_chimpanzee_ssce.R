...
#' subtypes in common with the other primates species (human, rhesus,
...
#' }
#'
#' @source Processed from Ma et al. chimpanzee neuron subtypes pseudobulk
#' @export
ma_neu_chimpanzee_ssce <- function() {
  filepath <- system.file("extdata", paste0("ma_neu_chimpanzee_ssce", ".rda"), package = "GeneSLand")
