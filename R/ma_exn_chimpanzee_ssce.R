...
#' }
#'
#' @source Processed from Ma et al. chimpanzee excitatory neurons subtypes pseudobulk
#' @export
ma_exn_chimpanzee_ssce <- function() {
  filepath <- system.file("extdata", paste0("ma_exn_chimpanzee_ssce", ".rda"), package = "GeneSLand")
